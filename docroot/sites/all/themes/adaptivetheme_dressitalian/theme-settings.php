...
/**
 * USAGE:
 * 1 - To use this file replace "adaptivetheme_dressitalian" with the name of
...
// Replace 'adaptivetheme_dressitalian' with your themes name, eg:
// function your_themes_name_form_system_theme_settings_alter(&$form, &$form_state)
function adaptivetheme_dressitalian_form_system_theme_settings_alter(&$form, &$form_state)  {
  ...
  if (theme_get_setting('style_enable_schemes') == 'on') {
    ...
    $form['at']['style']['style_schemes'] = array(
      ...
      '#options' => array(
        ...
        // 'my-style.css' => t('My Style'), // Add your schemes, these MUST be placed in your dressitalians /schemes directory!
      ),
    );
