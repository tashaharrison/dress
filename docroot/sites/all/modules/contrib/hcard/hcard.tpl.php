<?php
// $Id: hcard.tpl.php,v 1.1.2.1 2009/01/18 07:06:02 shawndearmond Exp $
 ...
 *
 * - $given_name: The given-name value, wrapped in a l() function.
 * - $family_name: The family-name value, wrapped in a l() function.
 * - $org: The family-name value. Likely the name of the business or organization, wrapped in a l() function.
 *
 * - $tagline: The tagline including links.
 *
 ...
 *
 * - $category_links: An array of categories processed into links.
 *
 */

  drupal_add_css(drupal_get_path('module', 'hcard') .'/hcard.css');
?>
<div id="hcard<?php if ($given_name || $family_name) print "-". check_plain($hcard['given_name']) ."-". check_plain($hcard['family_name']); ?>" class="vcard">
  ...
  <div class="geo">
    <abbr class="longitude" title="<?php print $longitude; ?>"><?php print hcard_coord_convert($longitude, 'longitude')?></abbr>
    <abbr class="latitude" title="<?php print $latitude; ?>"><?php print hcard_coord_convert($latitude, 'latitude')?></abbr>
  </div>
  ...
  <div class="tags"><?php print implode(', ', $category_links); ?></div>
