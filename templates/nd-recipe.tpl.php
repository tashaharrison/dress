...
<div class="buildmode-<?php print $node->build_mode; ?>">
  <div class="node node-type-<?php print $node->type; ?> <?php foreach ($node->taxonomy as $item) { if ($item->vid == 4){print $item->name;} } ?><?php if (isset($node_classes)): print $node_classes; endif; ?><?php if ($sticky && $node->build_mode == 'sticky'): print ' sticky'; endif; ?><?php if (!$status): print ' node-unpublished'; endif; ?> clear-block">
    <?php print $content; ?>
  </div> <!-- /node -->
</div> <!-- /buildmode -->
